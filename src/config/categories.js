...
export const FIELD_DEFS = {
  ...
  alturaTotal:  { label: "Alt. Total",   placeholder: "0.00", unit: "mm" },
...
const CATEGORIES = [
  {
    ...
    columns: ["Codigo", "Tipo", "Externo", "Interno", "AlturaBase", "AlturaTotal"],
    fields: ["interno", "externo", "alturaBase", "alturaTotal"],
